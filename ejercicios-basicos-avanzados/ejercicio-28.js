/* Dada una lista de álbumes de música, utiliza un bucle para sumar todas las duraciones solo de 
los álbumes de rock y luego imprime el total de estas duraciones por consola. */
const albums = [ 
...
function sumDuration (list, genre){
    let totalDuration=0;
    for (element of list){
        if(element['genre']===genre)totalDuration+=element.duration
    }
    return totalDuration;
}

console.log(sumDuration(albums, "Rock"))