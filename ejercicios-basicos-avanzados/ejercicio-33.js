...
La función debe manejar casos en los que el país no esté en la lista, devolviendo un mensaje 
adecuado. */
...
function getCapital(country) { 
    ...
    else return "Error 404: Country not found"
}
console.log(getCapital("Hungary"))
console.log(getCapital("Hungaro"))
