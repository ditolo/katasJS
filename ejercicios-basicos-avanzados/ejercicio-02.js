...
• Actualiza el precio final (precioFinal) de dos naves ("Ala-X" y "Halcón Milenario") sumando el 
valor de precioBaseGlobal a su precio base (precioBase). */
...
console.log("El precio final del " + nave1.nombre + " es: " + nave1.precioFinal);
