...
const odlSchoolLolPlayers = streamers2.filter (streamer => streamer.gameMorePlayed.includes('Legends') ? streamer.age > 35 ? streamer.gameMorePlayed = streamer.gameMorePlayed.toLocaleUpperCase() : streamer : null);
console.log(odlSchoolLolPlayers);

//menos oneLiner:
const odlSchoolLolPlayers2 = streamers.filter (streamer => {
...
console.log(odlSchoolLolPlayers2);